...
public class AccessTokenRequest {
    ...
    public AccessTokenResponse requestAccessToken(String authorization_code) {
        ...
        try {
            ...
            String data = "grant_type=authorization_code&code=" + authorization_code + "&redirect_uri=" + redirect_uri + "";
